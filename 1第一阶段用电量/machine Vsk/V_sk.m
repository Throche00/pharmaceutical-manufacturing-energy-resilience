...
num_trials = 100; % 每个点进行 100 次独立的蒙特卡洛离散事件仿真
T_sim = 168; % 模拟 168 小时 (一周)
...
for i = 1:N_tests
    ...
    % --- Step A: Calculate theoretical capacity limit (Amdahl's Law Effect) ---
    ...
    for trial = 1:num_trials
        ...
        PT = min(PT, 1.0); % Absolute physical constraint
...
%% 5. Plot
figure('Position',[100 150 1200 450],'Color','w','Name','Machine Speed v_sk'); % 稍微增加高度以适应双行xlabel
